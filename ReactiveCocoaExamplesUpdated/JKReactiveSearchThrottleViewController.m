...
- (void)viewDidLoad {
    ...
    [signalForSearchField subscribeNext:^(NSString* searchString) {
        self.outputMessage.text = [NSString stringWithFormat:@"Value entered in the search bar is %@. Output after delay of 0.5 second", searchString];
    }];
}
